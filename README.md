...
We are currently in the process of streamlining our original code into this notebook.

It will also act as an example of how to use the *comfortSIM* Python [modules](/lib/comfortSIM). Most functions currently defined in the notebook will be part of the *comfortSIM* library. With this Python library we aim to develop a module that acts as the interface between two-dimensional building simulation and common Data Science and Machine Learning libraries. 

<img src="./img/climateSIM-logo.png" width="150" height="163">
